...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isatty__FK5lmHTzEdX6epYBp9bfgMg)(FILE* f);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, endOfFile__FK5lmHTzEdX6epYBp9bfgMg_2)(FILE* f);
...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_11, "kernel32", 8);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_12, "kernel32", 8);
...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_24, "errno: ", 7);
...
static void* TM__MnCJ0VAmeZ9aTATUB39cx60Q_9;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	{
		...
		NimStringDesc* T34_;
		T3_ = (NIM_BOOL)0;
		T3_ = isatty__FK5lmHTzEdX6epYBp9bfgMg(f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = endOfFile__FK5lmHTzEdX6epYBp9bfgMg_2(file);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		{
...
{	T1_ = (tyObject_EOFError__KGSY1JdrNB7Xi8KDhXFhSg*)0;
	...
	(*T1_).Sup.Sup.Sup.message = copyString(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_25));
...
if (!((TM__MnCJ0VAmeZ9aTATUB39cx60Q_9 = nimLoadLibrary(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_11)))
)) nimLoadLibraryError(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_12));
	Dl_3980401_ = (tyProc__PUnN9cBvfpDX0GlY5QGXGXw) nimGetProcAddr(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "ReadConsoleW");
	Dl_3980409_ = (tyProc__9bXer9a4ps9aSGctILcxWReVw) nimGetProcAddr(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "GetLastError");
	Dl_3980411_ = (tyProc__aO673xGTLLxou7P7GxoCXA) nimGetProcAddr(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "FormatMessageW");
	Dl_3980420_ = (tyProc__im9buRnIvptJfzdASYMEbBA) nimGetProcAddr(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "LocalFree");
}
