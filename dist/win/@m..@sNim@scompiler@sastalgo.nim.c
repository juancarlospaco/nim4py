...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	(*this_0).res = resizeString((*this_0).res, 1);
	...
	(*this_0).currentLine += ((NI) 1);
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				(*this_0).res = addChar((*this_0).res, 32);
				i_2 += ((NI) 1);
			} LA3: ;
		}
	}
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (key ? key->Sup.len : 0) + 0);
appendString((*this_0).res, key);
	(*this_0).res = resizeString((*this_0).res, 3);
...
N_LIB_PRIVATE N_NIMCALL(void, value__IoQuLXtIJvnyXSTPrJspcg)(tyObject_DebugPrinter__a6duEI3KVtgLLu9cNBssigA* this_0, tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw value) {
	{
		...
		(*this_0).res = resizeString((*this_0).res, 5);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	}
	LA3_: ;
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__cNCW9acsSznmEccl1fgQwkw_)) ? reprEnum((NI)value, (&NTI__cNCW9acsSznmEccl1fgQwkw_))->Sup.len : 0) + 0);
appendString((*this_0).res, reprEnum((NI)value, (&NTI__cNCW9acsSznmEccl1fgQwkw_)));
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	{
		if (!(*this_0).useColor) goto LA7_;
		(*this_0).res = resizeString((*this_0).res, 4);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_15));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (value ? value->Sup.len : 0) + 0);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__K9ay6LWMat9bUiT9bIbMxpDHw_)) ? reprEnum((NI)value, (&NTI__K9ay6LWMat9bUiT9bIbMxpDHw_))->Sup.len : 0) + 0);
...
N_LIB_PRIVATE N_NIMCALL(void, comma__EAEW3Bgfb2rBayBNQm2DKA_5)(tyObject_DebugPrinter__a6duEI3KVtgLLu9cNBssigA* this_0) {
	(*this_0).res = resizeString((*this_0).res, 2);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__9a3YiReNVD0IJHWFKgXRe9ag_)) ? reprEnum((NI)value, (&NTI__9a3YiReNVD0IJHWFKgXRe9ag_))->Sup.len : 0) + 0);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__x2m5g1NpbmDig4wLT3Ylhw_)) ? reprEnum((NI)value, (&NTI__x2m5g1NpbmDig4wLT3Ylhw_))->Sup.len : 0) + 0);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__G4E4Gxe7oI2Cm03rkiOzQw_)) ? reprEnum((NI)value, (&NTI__G4E4Gxe7oI2Cm03rkiOzQw_))->Sup.len : 0) + 0);
...
{nimErr_ = nimErrorFlag();
	...
	T15_ = makeYamlString__P4HN4Rp9arTWym9cdDnUDu8Q(T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_[0] = T15_;
	T16_ = (NI)0;
	T16_ = toLinenumber__6D4Rmpw7LpcRI1j7CMqEsAmsgs(info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T17_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T17_ = rope__KOisMGxcPhz6CcSmxgwEQQ(((NI64) (T16_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_[1] = T17_;
	T18_ = (NI)0;
	T18_ = toColumn__6D4Rmpw7LpcRI1j7CMqEsA_2msgs(info);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T19_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T19_ = rope__KOisMGxcPhz6CcSmxgwEQQ(((NI64) (T18_)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_[2] = T19_;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_13));
	...
	(*this_0).res = resizeString((*this_0).res, 1);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_10));
	(*this_0).res = resizeString((*this_0).res, (reprEnum((NI)value, (&NTI__jyh9acXHkhZANSSvPIY7ZLg_)) ? reprEnum((NI)value, (&NTI__jyh9acXHkhZANSSvPIY7ZLg_))->Sup.len : 0) + 0);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_2));
	...
	LA3_: ;
	indexX60gensym123_ = getOrDefault__ucLvuteXMiAMAvKs77J1uw((*this_0).visited, ((void*) (value)), ((NI) -1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(indexX60gensym123_ < ((NI) 0))) goto LA7_;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_3));
		...
		LA12_: ;
		(*this_0).res = resizeString((*this_0).res, 9);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_4));
		addInt__mftMOxbyu0h4yByfs3sqjA((&(*this_0).res), ((NI64) ((NI)((*this_0).currentLine - indexX60gensym123_))));
		(*this_0).res = resizeString((*this_0).res, 15);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_6));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_DebugPrinter__a6duEI3KVtgLLu9cNBssigA* T22_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T22_ = (tyObject_DebugPrinter__a6duEI3KVtgLLu9cNBssigA*)0;
		T22_ = this_0;
		T23_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
		T23_ = lineInfoToStr__o5OvO09cfEJ7lAWvUTH12Yw((*this_0).conf, (*value).info);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T24_ = (NimStringDesc*)0;
		T24_ = dollar___mZ66tEveFIQokq3arf8Klw(T23_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		value__FzAGrI1bDlDZrjbkaI7wWw(T22_, T24_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA20_: ;
	{
		if (!(((NI) 0) < countBits32((*value).flags))) goto LA27_;
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 18):
	{
		...
		T31_ = toStrMaxPrecision__ayHojnbqAtgkZF8TXMNMzg((*value)._kind_2.floatVal, ((NimStringDesc*) NIM_NIL));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		value__FzAGrI1bDlDZrjbkaI7wWw(this_0, T31_);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	break;
	...
	{
		{
			if (!!(((*value)._kind_5.ident == NIM_NIL))) goto LA37_;
	...
	{
		{
			NIM_BOOL T42_;
			T42_ = (NIM_BOOL)0;
			T42_ = (*this_0).renderSymType;
			if (!(T42_)) goto LA43_;
			T42_ = !(((*value).typ == NIM_NIL));
			LA43_: ;
			if (!T42_) goto LA44_;
		...
		LA44_: ;
		{
			NI T48_;
			T48_ = (NI)0;
			T48_ = len__P89cqdlERShb9alU3iC0yj8wast(value);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				...
				i_2 = ((NI) 0);
				{
					while (1) {
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						{
							NI T56_;
							T56_ = (NI)0;
							T56_ = len__P89cqdlERShb9alU3iC0yj8wast(value);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							if (!!((i == (NI)(T56_ - ((NI) 1))))) goto LA57_;
							comma__EAEW3Bgfb2rBayBNQm2DKA_5(this_0);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						}
						LA57_: ;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_2));
	...
	LA3_: ;
	indexX60gensym114_ = getOrDefault__ucLvuteXMiAMAvKs77J1uw((*this_0).visited, ((void*) (value)), ((NI) -1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(indexX60gensym114_ < ((NI) 0))) goto LA7_;
		X5BX5Deq___7nUN9bEb8it8esEzVF54z3Q((&(*this_0).visited), ((void*) (value)), (*this_0).currentLine);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA5_;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_3));
		...
		(*this_0).res = resizeString((*this_0).res, 9);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_4));
		addInt__mftMOxbyu0h4yByfs3sqjA((&(*this_0).res), ((NI64) ((NI)((*this_0).currentLine - indexX60gensym114_))));
		(*this_0).res = resizeString((*this_0).res, 15);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_5));
		{
			if (!(*this_0).useColor) goto LA16_;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_2));
	...
	LA3_: ;
	indexX60gensym94_ = getOrDefault__ucLvuteXMiAMAvKs77J1uw((*this_0).visited, ((void*) (value)), ((NI) -1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!(indexX60gensym94_ < ((NI) 0))) goto LA7_;
		X5BX5Deq___7nUN9bEb8it8esEzVF54z3Q((&(*this_0).visited), ((void*) (value)), (*this_0).currentLine);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	goto LA5_;
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_3));
		...
		(*this_0).res = resizeString((*this_0).res, 9);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_4));
		addInt__mftMOxbyu0h4yByfs3sqjA((&(*this_0).res), ((NI64) ((NI)((*this_0).currentLine - indexX60gensym94_))));
		(*this_0).res = resizeString((*this_0).res, 15);
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_5));
		{
			if (!(*this_0).useColor) goto LA16_;
...
{nimErr_ = nimErrorFlag();
	...
	initTable__avINVlbIK12XSqjy8oSlzg(((NI) 32), (&this_1.visited));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T7_ = T6_;
			T8_ = getInt__Ml9bTZ5dXYSLBfnGRkErokw(b);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			result = eqeq___7c5Zw7H31uJfWmmhZe9aEqw(T7_, T8_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA4_: ;
	}
	...
	{
		{
			if (!((*b).kind >= ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 16) && (*b).kind <= ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 18))) goto LA12_;
	...
	{
		{
			if (!((*b).kind >= ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 20) && (*b).kind <= ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 22))) goto LA17_;
...
{nimErr_ = nimErrorFlag();
	...
	T14_ = (NI)0;
	T14_ = nextTry__9bzOSawou0eb9apAqvIEoEGgastalgo(h, T13_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*ti).h = T14_;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	T17_ = (NI)0;
	T17_ = nextTry__9bzOSawou0eb9apAqvIEoEGgastalgo(h, T16_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*ti).h = T17_;
	{
		NIM_BOOL T20_;
		...
		T20_ = !((result == NIM_NIL));
		if (!(T20_)) goto LA21_;
		T20_ = contains__R6uRTGpl30Ofaw4Ni3vawA(excluding, (*result).Sup.id);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		LA21_: ;
		if (!T20_) goto LA22_;
		result = NIM_NIL;
	...
	{
		{
			...
			T8_ = getInt__Ml9bTZ5dXYSLBfnGRkErokw(b);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			result = lteq___7c5Zw7H31uJfWmmhZe9aEqw_2(T7_, T8_);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		LA4_: ;
	}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, listSymbolNames__8Z1zCwaGnI7ov1q9bc6s4uQ)(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w** symbols, NI symbolsLen_0) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	{
		tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w** sym;
...
appendString(result, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_21));
				}
				LA6_: ;
