...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*, getSysSym__9bvw79ck1FDiWpnBYh88rEfw)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, NimStringDesc* name) {
	...
	result = strTableGet__2ZDXFT8aKmu3vdgfJFQCgQ((*(*g).systemModule)._kind_3.tab, T1_);
	{
		NimStringDesc* T6_;
...
appendString(T6_, name);
		...
		(*result).typ = newType__SNqpa06pdVCLFFBR28119aQ(((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 50), (*g).systemModule);
	}
	LA4_: ;
	{
...
appendString(T38_, ((NimStringDesc*) &TM__X5WDdcxsp0AxLUoaF7I29bA_23));
appendString(T38_, reprEnum((NI)kind, (&NTI__9a3YiReNVD0IJHWFKgXRe9ag_)));
appendString(T38_, ((NimStringDesc*) &TM__X5WDdcxsp0AxLUoaF7I29bA_24));
appendString(T38_, reprEnum((NI)(*result).kind, (&NTI__9a3YiReNVD0IJHWFKgXRe9ag_)));
			internalError__5hPl6LjCYJxMYxh9af9b9bXzw((*g).config, T38_);
		}
		LA31_: ;
	}
	LA29_: ;
...
appendString(T43_, ((NimStringDesc*) &TM__X5WDdcxsp0AxLUoaF7I29bA_25));
appendString(T43_, reprEnum((NI)kind, (&NTI__9a3YiReNVD0IJHWFKgXRe9ag_)));
		internalError__5hPl6LjCYJxMYxh9af9b9bXzw((*g).config, T43_);
	}
	LA41_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, setIntLitType__JsZMQGDyZXnGr9cg0jxXW0w)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result) {
	...
	case ((NI) 4):
	{
		...
		LA7_: ;
		{
			(*result).typ = getSysType__VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 35));
		}
		LA3_: ;
	}
	break;
	case ((NI) 2):
	{
		...
		LA15_: ;
		{
			...
			LA19_: ;
			if (!T18_) goto LA20_;
			(*result).typ = getSysType__VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 34));
		}
		goto LA11_;
		LA20_: ;
		{
	...
	case ((NI) 1):
	{
		...
		LA28_: ;
		{
			...
			LA32_: ;
			if (!T31_) goto LA33_;
			(*result).typ = getSysType__VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 33));
		}
		goto LA24_;
		LA33_: ;
		{
