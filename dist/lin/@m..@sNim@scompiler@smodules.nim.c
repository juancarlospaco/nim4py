...
STRING_LITERAL(TM__M5T16KOkc0tDi9bZeKl6v1w_5, "system.nim", 10);
...
N_LIB_PRIVATE N_NIMCALL(void, partialInitModule__eelaJUyoBMuhkxminjeGOw)(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* result, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, NimStringDesc* filename) {
	...
	LA8_: ;
	{
		...
		existing = strTableGet__2ZDXFT8aKmu3vdgfJFQCgQ((*packSym)._kind_3.tab, (*result).name);
		{
			NIM_BOOL T14_;
			NimStringDesc* pck3;
			...
			packSym = newSym__IXbidcxhXTQGZY9abN63Cxg(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 24), T18_, packSym, (*result).info, 0);
			initStrTable__2n9b6ELeZfbbP5wqNYm7VyA((&(*packSym)._kind_3.tab));
			strTableAdd__tyTgUybFIoow4CX2l5beug((&(*graph).packageSyms), packSym);
		}
		LA16_: ;
...
appendString(T8_, (*(*result).name).s);
		rawMessage__h30HgTFwbGq0PsyHmRqZ8g((*graph).config, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), T8_);
	}
	LA6_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*, compileModule__G7A63DimkOmtueyLoB89c8w)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, tySet_tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw flags) {
	...
	result = getModule__M1TGnt0pSqOaMTLwmaJc6A(graph, fileIdx);
	{
		...
		T11_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
		{
			NIM_BOOL T14_;
			T14_ = (NIM_BOOL)0;
			T14_ = ((flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0);
			if (!(T14_)) goto LA15_;
	...
	LA3_: ;
	{
		...
		T24_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
		{
			NIM_BOOL T27_;
			T27_ = (NIM_BOOL)0;
			T27_ = ((flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0);
			if (!(T27_)) goto LA28_;
...
N_LIB_PRIVATE N_NIMCALL(void, compileSystemModule__bgKSaiGTRW4vbGh2XuGqSw_2)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph) {
	{
		...
		T5_ = (NimStringDesc*)0;
		T5_ = slash___QVqo5OOQAdrjFqBsPctklw((*(*graph).config).libpath, ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_5));
		...
		T6_ = compileModule__G7A63DimkOmtueyLoB89c8w(graph, (*(*graph).config).m.systemFileIdx, 32768);
		(void)(T6_);
	}
	LA3_: ;
}
