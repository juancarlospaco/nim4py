...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		...
		{
			result = sameFloatIgnoreNan__ZHjXPPi0kcAio2Zeegfpmgtrees((*a)._kind_2.floatVal, (*b)._kind_2.floatVal);
		}
		break;
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							i = i_2;
							{
								NIM_BOOL T36_;
								T36_ = (NIM_BOOL)0;
								T36_ = exprStructuralEquivalent__E1mnSzj2NONtG7h9cR3AuFA((*a)._kind_6.sons->data[i], (*b)._kind_6.sons->data[i], strictSymEquality);
								if (!!(T36_)) goto LA37_;
								goto BeforeRet_;
							}
							LA37_: ;
