...
;
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_7, "/home/runner/work/nim4py/nim4py/Nim/compiler/passes.nim", 55);
				...
				LA69_: ;
				{
					while (1) {
						...
						LA84_: ;
						{
							...
							if (T90_) goto LA91_;
							T90_ = (((*(*graph).config).features &((NU16)1<<((NU)(((tyEnum_Feature__01UoAKYz1MxZiuG1X2VhNQ) 9))&15U)))!=0);
							LA91_: ;
							T88_ = T90_;
							LA89_: ;
							if (!T88_) goto LA92_;
							...
							} LA94: ;
							{
								...
								T102_ = (((*(*graph).config).features &((NU16)1<<((NU)(((tyEnum_Feature__01UoAKYz1MxZiuG1X2VhNQ) 9))&15U)))!=0);
								LA103_: ;
