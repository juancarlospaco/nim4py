...
static NIM_CONST tyProc__xdLb0cyzx3FuM6Q4NnRTpQ TM__Tko7U9cii9bC6Kt2otnwMmCg_2 = {NIM_NIL,NIM_NIL};
extern TNimType NTI__WENTuyElSRFloaVOQEDvMg_;
static NIM_CONST tySet_tyEnum_TMsgKind__9aTDTIqNJIW9bjpBdW7rixiA TM__Tko7U9cii9bC6Kt2otnwMmCg_4 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00}
;
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_5, "stdlib", 6);
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_6, "distros", 7);
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_7, "nimscriptapi", 12);
STRING_LITERAL(TM__Tko7U9cii9bC6Kt2otnwMmCg_9, "passes.nim", 10);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Tko7U9cii9bC6Kt2otnwMmCg_8 = {((NimStringDesc*) &TM__Tko7U9cii9bC6Kt2otnwMmCg_9),
((NI) 51),
((NI) 17)}
;
...
N_LIB_PRIVATE N_NIMCALL(void, prepareConfigNotes__aErgAxFWejI8802zxMk6Ug)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* module) {
	{
		if (!(((*module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 14))&63U)))!=0)) goto LA3_;
	...
	{
		{
			if (!(nimCmpMem((*(*graph).config).mainPackageNotes, TM__Tko7U9cii9bC6Kt2otnwMmCg_4, 9)==0)) goto LA12_;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				{
					...
					a[(i)- 0] = (*g).passes->data[i].Field0(g, module);
				}
				goto LA5_;
				LA7_: ;
				{
		...
		LA51_: ;
		{
			while (1) {
				openParsers__yIpcSxqaMQcd6kNqikzXtg((&p), fileIdx, s, (*graph).cache, (*graph).config);
				{
					...
					if (T65_) goto LA66_;
					T65_ = !(eqStrings((*(*(*module).owner).name).s, ((NimStringDesc*) &TM__Tko7U9cii9bC6Kt2otnwMmCg_5)));
					LA66_: ;
					T64_ = T65_;
					if (T64_) goto LA67_;
					T64_ = eqStrings((*(*module).name).s, ((NimStringDesc*) &TM__Tko7U9cii9bC6Kt2otnwMmCg_6));
					LA67_: ;
					if (!T64_) goto LA68_;
					{
						if (!!(eqStrings((*(*module).name).s, ((NimStringDesc*) &TM__Tko7U9cii9bC6Kt2otnwMmCg_7)))) goto LA72_;
				...
				LA68_: ;
				{
					while (1) {
						...
						LA83_: ;
						{
							...
							NIM_BOOL T105_;
							T87_ = (NIM_BOOL)0;
							T87_ = !((((*module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 15))&63U)))!=0));
							if (!(T87_)) goto LA88_;
							T89_ = (NIM_BOOL)0;
							T89_ = !(((1040 & (*module).flags) == 0));
							if (T89_) goto LA90_;
							T89_ = (((*(*graph).config).features &(1U<<((NU)(((tyEnum_Feature__01UoAKYz1MxZiuG1X2VhNQ) 9))&15U)))!=0);
							LA90_: ;
							T87_ = T89_;
							LA88_: ;
							if (!T87_) goto LA91_;
							...
							} LA93: ;
							{
								...
								T101_ = (((*(*graph).config).features &(1U<<((NU)(((tyEnum_Feature__01UoAKYz1MxZiuG1X2VhNQ) 9))&15U)))!=0);
								LA102_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, registerPass__VbG3eW9b2jtFMJI9bafKW9aRw)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyTuple__euPCXX9bc3XzndEhYlqNS7g* p) {
	NI T7_;
	{
		...
		T6_ = (NimStringDesc*)0;
		T6_ = dollar___r38WafKlW80RkvoZTcia4Q(TM__Tko7U9cii9bC6Kt2otnwMmCg_8);
