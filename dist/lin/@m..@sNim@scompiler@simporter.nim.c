...
appendString(err, T18_);
		...
		result = importModuleAs__V9agTyg7qixRKyk59a8fQeWA(c, n, T22_);
		...
		LA27_: ;
		{
			if (!(((*result).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 22))&63U)))!=0)) goto LA31_;
			{
				NimStringDesc* T37_;
				if (!!(((*result).constraint == NIM_NIL))) goto LA35_;
				T37_ = (NimStringDesc*)0;
				T37_ = rawNewString(((*(*result).constraint)._kind_3.strVal ? (*(*result).constraint)._kind_3.strVal->Sup.len : 0) + ((*(*result).name).s ? (*(*result).name).s->Sup.len : 0) + 16);
appendString(T37_, (*(*result).constraint)._kind_3.strVal);
appendString(T37_, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_7));
appendString(T37_, (*(*result).name).s);
appendString(T37_, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_8));
				message__mMj7lrOf3zBP9bl69amiKu5g((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 16), T37_);
			}
			goto LA33_;
			LA35_: ;
			{
...
appendString(T39_, ((NimStringDesc*) &TM__NsDkQfDe2CjzDqtBRW9bqQg_8));
				message__mMj7lrOf3zBP9bl69amiKu5g((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 16), T39_);
			}
			LA33_: ;
		}
		LA31_: ;
		...
		T40_ = newSymNode__AFd9c9cdRrILXl9anrr9aRvqig(result, (*n).info);
		add__P8dDSotTW25BkfbyspojGg(importStmtResult, T40_);
	}
	LA3_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalImportExcept__xmufAMBjGiK9cy1UljniTyg_3)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	(*n)._kind_6.sons->data[((NI) 0)] = transformImportAs__xmufAMBjGiK9cy1UljniTyg_2(c, (*n)._kind_6.sons->data[((NI) 0)]);
	m = myImportModule__CVrUx9blms5FVPGpXYTGvdA(c, (*n)._kind_6.sons->data[((NI) 0)], result);
	{
		tyObject_IntSet__PQrmFm4BXFkFSVOUl1ojSg T5_;
		if (!!((m == NIM_NIL))) goto LA3_;
		(*n)._kind_6.sons->data[((NI) 0)] = newSymNode__I2DV2TmmOysY1ZEGW19b9bRg(m);
