...
N_LIB_PRIVATE N_NIMCALL(NI, hashIgnoreCase__6PCYkKlCNhq9cnRLnqWKkwQ_3)(NimStringDesc* x);
...
N_LIB_PRIVATE N_NIMCALL(NI, myhash__X5BdUJaOXir9aSEySVC9auGg_2)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	{
		result = hash__6PCYkKlCNhq9cnRLnqWKkwQ_2(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 1):
	{
		result = hashIgnoreCase__6PCYkKlCNhq9cnRLnqWKkwQ_3(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 2):
	{
		result = hashIgnoreStyle__6PCYkKlCNhq9cnRLnqWKkwQ(key);
	}
	break;
	}
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc**, nstTake)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	NI indexX60gensym15985297_;
	result = (NimStringDesc**)0;
	indexX60gensym15985297_ = rawGet__X5BdUJaOXir9aSEySVC9auGg(t, key);
	{
		if (!(((NI) 0) <= indexX60gensym15985297_)) goto LA3_;
		result = (&(*t).data->data[indexX60gensym15985297_].Field1);
	}
	goto LA1_;
	LA3_: ;
	{
...
appendString(T7_, key);
		...
		raiseExceptionEx((Exception*)T6_, "KeyError", "[]", "strtabs.nim", 143);
	}
	LA1_: ;
	return result;
}
		...
		{
			{
				while (1) {
					...
					(*t).data->data[i].Field0 = ((NimStringDesc*) NIM_NIL);
					(*t).data->data[i].Field1 = ((NimStringDesc*) NIM_NIL);
					{
						while (1) {
							NI T15_;
							i = (NI)((NI)(i + ((NI) 1)) & msk);
