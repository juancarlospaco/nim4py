...
STRING_LITERAL(TM__nMAaq4j1QFesTu9arq2iqvQ_2, "nimscript", 9);
STRING_LITERAL(TM__nMAaq4j1QFesTu9arq2iqvQ_3, "true", 4);
STRING_LITERAL(TM__nMAaq4j1QFesTu9arq2iqvQ_4, "nimconfig", 9);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_InterpretercolonObjectType___P52MELrsYCwBeooqRNfjVA*, createInterpreter__JxjZwy9bfJI09btLVEDQd2KQ)(NimStringDesc* scriptName, NimStringDesc** searchPaths, NI searchPathsLen_0, tySet_tyEnum_TSandboxFlag__JyPEhkAmDAldmLHNNrLR0A flags) {
	...
	defineSymbol__znuJizGq3isbcihOOtUY0A((*conf).symbols, ((NimStringDesc*) &TM__nMAaq4j1QFesTu9arq2iqvQ_2), ((NimStringDesc*) &TM__nMAaq4j1QFesTu9arq2iqvQ_3));
	defineSymbol__znuJizGq3isbcihOOtUY0A((*conf).symbols, ((NimStringDesc*) &TM__nMAaq4j1QFesTu9arq2iqvQ_4), ((NimStringDesc*) &TM__nMAaq4j1QFesTu9arq2iqvQ_3));
	T1_.Field0 = myOpen__aOG8hV039bfSL2VAm1lrf0Q;
	T1_.Field1 = myProcess__QAJdPOwMq9buTNGNGQO3ImA;
	T1_.Field2 = myClose__q2jGmbBjsPumxfsrswciWg;
	T1_.Field3 = NIM_TRUE;
	registerPass__VbG3eW9b2jtFMJI9bafKW9aRw(graph, (&T1_));
	T2_.Field0 = myOpen__4vajIPhcf9a5bJvp6m9ciz6A;
	T2_.Field1 = myProcess__Owg2e1qJ9cqcKRBQZVvmIWg;
	T2_.Field2 = myClose__9cMiASXBM9bgOmq0622U8U0g;
	...
	registerPass__VbG3eW9b2jtFMJI9bafKW9aRw(graph, (&T2_));
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				NI T6_;
				if (!(i < searchPathsLen_0)) goto LA5;
				p = searchPaths[i];
				...
				T6_ = (*conf).searchPaths->Sup.len++;
				(*conf).searchPaths->data[T6_] = copyString(p);
				{
					NIM_BOOL T9_;
					T9_ = (NIM_BOOL)0;
					T9_ = isEmpty__ZNWb41IwBSHCUIjlqlGoxgpathutils((*conf).libpath);
					if (!T9_) goto LA10_;
	...
	T12_ = (tyObject_InterpretercolonObjectType___P52MELrsYCwBeooqRNfjVA*)0;
	T12_ = (tyObject_InterpretercolonObjectType___P52MELrsYCwBeooqRNfjVA*) newObj((&NTI__Q9bTAr0cQIvITwsVu3p3ANw_), sizeof(tyObject_InterpretercolonObjectType___P52MELrsYCwBeooqRNfjVA));
	(*T12_).mainModule = m;
	(*T12_).graph = graph;
	(*T12_).scriptName = copyString(scriptName);
	result = T12_;
	return result;
}
...
static TNimNode* TM__nMAaq4j1QFesTu9arq2iqvQ_5_3[3];
...
TM__nMAaq4j1QFesTu9arq2iqvQ_5_3[0] = &TM__nMAaq4j1QFesTu9arq2iqvQ_0[1];
...
TM__nMAaq4j1QFesTu9arq2iqvQ_5_3[1] = &TM__nMAaq4j1QFesTu9arq2iqvQ_0[2];
...
TM__nMAaq4j1QFesTu9arq2iqvQ_5_3[2] = &TM__nMAaq4j1QFesTu9arq2iqvQ_0[3];
...
TM__nMAaq4j1QFesTu9arq2iqvQ_0[0].len = 3; TM__nMAaq4j1QFesTu9arq2iqvQ_0[0].kind = 2; TM__nMAaq4j1QFesTu9arq2iqvQ_0[0].sons = &TM__nMAaq4j1QFesTu9arq2iqvQ_5_3[0];
