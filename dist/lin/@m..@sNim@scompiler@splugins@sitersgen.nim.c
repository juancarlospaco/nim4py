...
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_4, "/home/runner/work/nim4py/nim4py/Nim/compiler/plugins/itersgen.n"
"im", 65);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__fVT8Frbe1eY8sI6VOwxZZg_3 = {((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4),
((NI) 18),
((NI) 14)}
;
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_5, "second argument needs to be a type", 34);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__fVT8Frbe1eY8sI6VOwxZZg_6 = {((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4),
((NI) 21),
((NI) 14)}
;
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_7, "third argument needs to be an identifier", 40);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__fVT8Frbe1eY8sI6VOwxZZg_8 = {((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4),
((NI) 24),
((NI) 14)}
;
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_9, "type must be a non-generic ref|ptr to object with state field", 61);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__fVT8Frbe1eY8sI6VOwxZZg_10 = {((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4),
((NI) 29),
((NI) 14)}
;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, iterToProcImpl__btx5NTZO5L9a6BLvqVh3UTw)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* T26_;
...
{nimErr_ = nimErrorFlag();
	...
	iter = (*n)._kind_6.sons->data[((NI) 1)];
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = !(((*iter).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3)));
		if (T3_) goto LA4_;
		T3_ = !(((*(*iter)._kind_4.sym).kind == ((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 15)));
		LA4_: ;
		if (!T3_) goto LA5_;
		liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, (*iter).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_2), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_3, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
	LA5_: ;
	{
		if (!((*(*n)._kind_6.sons->data[((NI) 2)]).typ == 0)) goto LA9_;
		liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_6, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
	LA9_: ;
	{
		if (!!(((*(*n)._kind_6.sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 3)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_7), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_8, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
	LA13_: ;
	t = skipTypes__zsqmUNR5OZrTUna0Y9bdu9bg((*(*n)._kind_6.sons->data[((NI) 2)]).typ, 2304);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T17_;
		...
		LA18_: ;
		if (!T17_) goto LA20_;
		liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_9), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_10, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
	LA20_: ;
	T22_ = (tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*)0;
	T22_ = (*iter)._kind_4.sym;
	body = liftIterToProc__t1WUr4lePynddtLnmYOFEQ((*c).graph, T22_, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons->data[((NI) 6)], t);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T23_ = (tyObject_TIdent__GufRQq9c0miSybX3zBD4tyA*)0;
	T23_ = (*(*n)._kind_6.sons->data[((NI) 3)])._kind_5.ident;
	T24_ = (tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*)0;
	T24_ = (*(*iter)._kind_4.sym).owner;
	prc = newSym__IXbidcxhXTQGZY9abN63Cxg(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), T23_, T24_, (*(*iter)._kind_4.sym).info, 0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T25_ = (tyObject_TType__v9ae2Dpu13OW2ZJ2U9bNMd9cQ*)0;
	T25_ = copyType__4O4aYoscFPo2FRSh4rP9ayg((*(*iter)._kind_4.sym).typ, prc, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*prc).typ = T25_;
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag__x2m5g1NpbmDig4wLT3Ylhw) 12)) & 63));
	T26_ = (tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*)0;
	T26_ = getEnvParam__0hs55xLsSn1sbFSXWwel1A((*iter)._kind_4.sym);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T27_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T27_ = newSymNode__I2DV2TmmOysY1ZEGW19b9bRg(T26_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	add__P8dDSotTW25BkfbyspojGg((*(*prc).typ).n, T27_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	rawAddSon__LW9aGb2JfjdMXhDZwQYa5xg((*prc).typ, t, NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	orig = (*(*iter)._kind_4.sym).ast;
	T28_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T28_ = (*orig)._kind_6.sons->data[((NI) 3)];
	T29_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T29_ = newSymNode__I2DV2TmmOysY1ZEGW19b9bRg(prc);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T30_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T30_ = newProcNode__g5PEkYP0A0RT03uHbJ6wKQ(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, T28_, T29_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig)._kind_6.sons->data[((NI) 4)], (*(*c).graph).emptyNode);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*prc).ast = T30_;
	add__P8dDSotTW25BkfbyspojGg((*prc).ast, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons->data[((NI) 7)]);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	addInterfaceDecl__aPXKqZJT9c7r7gT8X3uZAHw_3(c, prc);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
