...
{	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	LA5_: ;
	{
		...
		localError__NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_3));
		goto BeforeRet_;
	}
	LA9_: ;
	{
		if (!!(((*(*n)._kind_6.sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		localError__NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 3)]).info, ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4));
		goto BeforeRet_;
	}
	LA13_: ;
	t = skipTypes__zsqmUNR5OZrTUna0Y9bdu9bg((*(*n)._kind_6.sons->data[((NI) 2)]).typ, 2304);
	{
		...
		LA18_: ;
		if (!T17_) goto LA20_;
		localError__NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_5));
		goto BeforeRet_;
	}
	LA20_: ;
	body = liftIterToProc__t1WUr4lePynddtLnmYOFEQ((*c).graph, (*iter)._kind_4.sym, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons->data[((NI) 6)], t);
	prc = newSym__IXbidcxhXTQGZY9abN63Cxg(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), (*(*n)._kind_6.sons->data[((NI) 3)])._kind_5.ident, (*(*iter)._kind_4.sym).owner, (*(*iter)._kind_4.sym).info, 0);
	(*prc).typ = copyType__4O4aYoscFPo2FRSh4rP9ayg((*(*iter)._kind_4.sym).typ, prc, NIM_FALSE);
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag__x2m5g1NpbmDig4wLT3Ylhw) 12)) & 63));
	T22_ = (tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*)0;
	T22_ = getEnvParam__0hs55xLsSn1sbFSXWwel1A((*iter)._kind_4.sym);
	...
	(*prc).ast = newProcNode__g5PEkYP0A0RT03uHbJ6wKQ(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, (*orig)._kind_6.sons->data[((NI) 3)], T24_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig)._kind_6.sons->data[((NI) 4)], (*(*c).graph).emptyNode);
