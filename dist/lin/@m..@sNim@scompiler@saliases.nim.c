...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w, isPartOf__1otDDZAmvFsmbqPyFytXFg)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	result = (tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	{
			...
			{
				{
					...
					T18_ = isPartOf__TemHLbwRN019anIx4JpcPTQ((*(*a)._kind_4.sym).typ, (*(*b)._kind_4.sym).typ);
		...
		{
			result = isPartOf__1otDDZAmvFsmbqPyFytXFg((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 0)]);
			{
				NIM_BOOL T24_;
				NI T25_;
				NI T27_;
				...
				if (!T24_) goto LA28_;
				{
					...
					if (!(T33_)) goto LA34_;
					T33_ = isDeepConstExpr__sjm2oD6Aq9cG39aPE7CTvtmA((*a)._kind_6.sons->data[((NI) 1)], NIM_FALSE);
					LA34_: ;
					T32_ = T33_;
					if (!(T32_)) goto LA35_;
					T32_ = isDeepConstExpr__sjm2oD6Aq9cG39aPE7CTvtmA((*b)._kind_6.sons->data[((NI) 1)], NIM_FALSE);
					LA35_: ;
					if (!T32_) goto LA36_;
					{
		...
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 45):
		{
			result = isPartOf__1otDDZAmvFsmbqPyFytXFg((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 0)]);
			{
				...
				{
					if (!!(((*(*(*a)._kind_6.sons->data[((NI) 1)])._kind_4.sym).Sup.id == (*(*(*b)._kind_6.sons->data[((NI) 1)])._kind_4.sym).Sup.id))) goto LA71_;
					result = ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0);
				}
				LA71_: ;
			}
		...
		{
			result = isPartOf__1otDDZAmvFsmbqPyFytXFg((*a)._kind_6.sons->data[((NI) 1)], (*b)._kind_6.sons->data[((NI) 1)]);
		}
		break;
