...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_2, "rb", 2);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_3, "wb", 2);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_4, "w+b", 3);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_5, "r+b", 3);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_6, "ab", 2);
...
;
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_7, "errno: ", 7);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_8, " `", 2);
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9, "`", 1);
...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_13, "EOF reached", 11);
...
appendString(T6_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_7));
appendString(T6_, T7_);
appendString(T6_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_8));
...
appendString(T7_, filename);
		...
		raiseExceptionEx((Exception*)T6_, "IOError", "open", "io.nim", 589);
	}
	LA4_: ;
	return result;
}
...
appendString(T11_, filename);
		...
		raiseExceptionEx((Exception*)T10_, "IOError", "readFile", "io.nim", 693);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NOINLINE(void, raiseEOF__CA1KPE9bDgvXVjqamZd5T9bQ)(void) {
	...
	(*T1_).Sup.Sup.Sup.message = copyString(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_13));
	(*T1_).Sup.Sup.Sup.parent = NIM_NIL;
	raiseExceptionEx((Exception*)T1_, "EOFError", "raiseEOF", "io.nim", 141);
}
