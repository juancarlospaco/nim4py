...
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__N0xGjswvcjwwH43PvVNJAg_5 = {((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_6),
((NI) 47),
((NI) 23)}
;
		...
		res_2 = colontmp_;
		{
			while (1) {
				...
				LA34_: ;
				{
					...
					add__P8dDSotTW25BkfbyspojGg(result, T38_);
				}
				LA30_: ;
				res_2 += ((NI) 1);
			} LA29: ;
...
N_LIB_PRIVATE N_NIMCALL(void, evalTemplateAux__AHGrgjfRCGeqRF8aKpZ9apw)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* templ, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* actual, tyObject_TemplCtx__og0XwfDLUlsX2HzoVx0s3Q* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result) {
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		...
		s = (*templ)._kind_4.sym;
		{
			...
			{
				NIM_BOOL T12_;
				tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* xX60gensym58362146_;
				T12_ = (NIM_BOOL)0;
				...
				LA13_: ;
				if (!T12_) goto LA14_;
				xX60gensym58362146_ = (*actual)._kind_6.sons->data[(*s).position];
				{
					if (!((*xX60gensym58362146_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA18_;
					{
						tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* yX60gensym58362147_;
						yX60gensym58362147_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
						{
							NI i;
							NI colontmp_;
							NI i_2;
							i = (NI)0;
							colontmp_ = (NI)0;
							colontmp_ = safeLen__P89cqdlERShb9alU3iC0yj8w_2ast(xX60gensym58362146_);
							i_2 = ((NI) 0);
							{
								while (1) {
									if (!(i_2 < colontmp_)) goto LA23;
									i = i_2;
									yX60gensym58362147_ = (*xX60gensym58362146_)._kind_6.sons->data[i];
									add__P8dDSotTW25BkfbyspojGg(result, yX60gensym58362147_);
									i_2 += ((NI) 1);
								} LA23: ;
							}
						}
				...
				LA18_: ;
				{
					...
					T25_ = copyTree__Dsjo9bte8vGxzhtcSrsTyiQ_2(xX60gensym58362146_);
			...
			LA14_: ;
			{
				...
				NIM_BOOL T31_;
				NIM_BOOL T32_;
				tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* xX60gensym58380016_;
				NI T37_;
				T27_ = (NIM_BOOL)0;
				...
				xX60gensym58380016_ = (*actual)._kind_6.sons->data[(NI)((NI)(T37_ + (*s).position) - ((NI) 1))];
				{
					if (!((*xX60gensym58380016_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA40_;
					{
						tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* yX60gensym58380017_;
						yX60gensym58380017_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
						{
							NI i_3;
							NI colontmp__2;
							NI i_4;
							i_3 = (NI)0;
							colontmp__2 = (NI)0;
							colontmp__2 = safeLen__P89cqdlERShb9alU3iC0yj8w_2ast(xX60gensym58380016_);
							i_4 = ((NI) 0);
							{
								while (1) {
									if (!(i_4 < colontmp__2)) goto LA45;
									i_3 = i_4;
									yX60gensym58380017_ = (*xX60gensym58380016_)._kind_6.sons->data[i_3];
									add__P8dDSotTW25BkfbyspojGg(result, yX60gensym58380017_);
									i_4 += ((NI) 1);
								} LA45: ;
							}
						}
				...
				LA40_: ;
				{
					...
					T47_ = copyTree__Dsjo9bte8vGxzhtcSrsTyiQ_2(xX60gensym58380016_);
			...
			LA35_: ;
			{
				...
				LA60_: ;
				{
					...
					T66_ = (NIM_BOOL)0;
					T66_ = (((*s).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 36))&63U)))!=0);
					if (!(T66_)) goto LA67_;
					T66_ = !((((*(*c).config).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 43))&63U)))!=0));
					LA67_: ;
					if (!T66_) goto LA68_;
