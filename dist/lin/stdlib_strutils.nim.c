...
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_4, "strutils.nim(1995, 12) `sub.len > 0` ", 37);
...
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_20, "invalid enum value: ", 20);
...
appendString(T8_, s);
		...
		raiseExceptionEx((Exception*)T7_, "ValueError", "parseFloat", "strutils.nim", 1127);
	}
	LA5_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToLowerAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI) ((s ? s->Sup.len : 0))));
	{
		NI iX60gensym12605050_;
		NI colontmp_;
		NI res;
		iX60gensym12605050_ = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res = ((NI) 0);
		{
			while (1) {
				if (!(res <= colontmp_)) goto LA3;
				iX60gensym12605050_ = res;
				result->data[iX60gensym12605050_] = nsuToLowerAsciiChar(s->data[iX60gensym12605050_]);
				res += ((NI) 1);
			} LA3: ;
		}
	}
...
appendString(T10_, s);
		...
		raiseExceptionEx((Exception*)T9_, "ValueError", "parseBool", "strutils.nim", 1230);
	}
	LA5_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitChar)(NimStringDesc* s, NIM_CHAR sep, NI maxsplit) {
	...
	result = NIM_NIL;
	{
		NimStringDesc* xX60gensym12845039_;
		NI lastX60gensym12680133_;
		NI splitsX60gensym12680134_;
		xX60gensym12845039_ = (NimStringDesc*)0;
		lastX60gensym12680133_ = ((NI) 0);
		splitsX60gensym12680134_ = maxsplit;
		{
			while (1) {
				NI firstX60gensym12680135_;
				NI T12_;
				if (!(lastX60gensym12680133_ <= (s ? s->Sup.len : 0))) goto LA3;
				firstX60gensym12680135_ = lastX60gensym12680133_;
				{
					while (1) {
						NIM_BOOL T6_;
						T6_ = (NIM_BOOL)0;
						T6_ = (lastX60gensym12680133_ < (s ? s->Sup.len : 0));
						if (!(T6_)) goto LA7_;
						T6_ = !(((NU8)(s->data[lastX60gensym12680133_]) == (NU8)(sep)));
						LA7_: ;
						if (!T6_) goto LA5;
						lastX60gensym12680133_ += ((NI) 1);
					} LA5: ;
				}
				{
					if (!(splitsX60gensym12680134_ == ((NI) 0))) goto LA10_;
					lastX60gensym12680133_ = (s ? s->Sup.len : 0);
				}
				LA10_: ;
				xX60gensym12845039_ = substr__2yh9cer0ymNRHlOOg8P7IuA(s, firstX60gensym12680135_, (NI)(lastX60gensym12680133_ - ((NI) 1)));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_));
				T12_ = result->Sup.len++;
				result->data[T12_] = copyString(xX60gensym12845039_);
				{
					if (!(splitsX60gensym12680134_ == ((NI) 0))) goto LA15_;
					goto LA2;
				}
				LA15_: ;
				splitsX60gensym12680134_ -= ((NI) 1);
				lastX60gensym12680133_ += ((NI) 1);
			} LA3: ;
		} LA2: ;
	}
...
appendString(T8_, s);
		(*T7_).Sup.Sup.message = T8_;
		(*T7_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T7_, "ValueError", "parseBiggestInt", "strutils.nim", 1096);
	}
	LA5_: ;
	return result;
}
...
appendString(T8_, s);
		(*T7_).Sup.Sup.message = T8_;
		(*T7_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T7_, "ValueError", "parseHexInt", "strutils.nim", 1167);
	}
	LA5_: ;
	return result;
}
...
appendString(T10_, ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_20));
appendString(T10_, s);
	(*T9_).Sup.Sup.message = T10_;
	(*T9_).Sup.Sup.parent = NIM_NIL;
	raiseExceptionEx((Exception*)T9_, "ValueError", "parseEnum", "strutils.nim", 1252);
	}BeforeRet_: ;
	return result;
}
