...
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_8, "The specified root is not absolute: ", 36);
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_9, "os.nim(1369, 21) `bufsize >= 0` ", 32);
static NIM_CONST tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ TM__yu6cxgKBBXbNsTkT9cyMd4g_10 = {((NI) 0),
((NI) -1)}
;
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_11, "..", 2);
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_12, "/proc/self/exe", 14);
...
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_14, "Failed to create \'", 18);
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_15, "\'", 1);
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_16, "\'\'", 2);
static NIM_CONST tySet_tyChar__nmiMWKVIe46vacnhAFrQvw TM__yu6cxgKBBXbNsTkT9cyMd4g_17 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xe8, 0xff, 0x27,
0xff, 0xff, 0xff, 0x87, 0xfe, 0xff, 0xff, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM__yu6cxgKBBXbNsTkT9cyMd4g_18, "\'\"\'\"\'", 5);
...
{nimErr_ = nimErrorFlag();
	T1_ = (NimStringDesc*)0;
	T1_ = normalizePath__gol9aBbIZpJYUPc6xBOBJDQ((*path), 47);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	(*path) = T1_;
	}BeforeRet_: ;
}
			...
			LA7_: ;
			{
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				{
					...
					bufsize = (NI)((NU64)(bufsize) << (NU64)(((NI) 1)));
					{
						...
						failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_9));
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
...
{nimErr_ = nimErrorFlag();
	...
	ff = TM__yu6cxgKBBXbNsTkT9cyMd4g_10;
	bb = TM__yu6cxgKBBXbNsTkT9cyMd4g_10;
...
{nimErr_ = nimErrorFlag();
	result = (NimStringDesc*)0;
	result = getApplAux__wpMsAlcjbgVsRya70vX0Ug(((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_12));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA8_: ;
	path = getEnv__hhED57tMl0Iaa5bOg9cJaig(((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_13), ((NimStringDesc*) NIM_NIL));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		splitsX60gensym26_ = ((NI) -1);
		{
			while (1) {
				...
				candidate = substr__2yh9cer0ymNRHlOOg8P7IuA(path, firstX60gensym26_, (NI)(lastX60gensym26_ - ((NI) 1)));
				{
					...
					T34_ = expandTilde__RmQRR8GLDFICboxWoCEpMw_2(candidate);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString(T12_, ((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_14));
appendString(T12_, dir);
appendString(T12_, ((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_15));
...
{nimErr_ = nimErrorFlag();
	result = (NimStringDesc*)0;
	{
		...
		result = copyString(((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_16));
		goto BeforeRet_;
	}
	LA3_: ;
	safe = allCharsInSet__dubrHoRt3C9a0HlJjsxM5ig(s, TM__yu6cxgKBBXbNsTkT9cyMd4g_17);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		if (!safe) goto LA7_;
		result = copyString(s);
	...
	LA7_: ;
	{
		...
		T11_ = nsuReplaceStr(s, ((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_15), ((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_18));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T10_ = rawNewString((T11_ ? T11_->Sup.len : 0) + 2);
appendString(T10_, ((NimStringDesc*) &TM__yu6cxgKBBXbNsTkT9cyMd4g_15));
