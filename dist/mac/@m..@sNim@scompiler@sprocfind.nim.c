...
"t $2", 67);
STRING_LITERAL(TM__UQi3TxvDqkoRVo8YKAWcxA_4, "/Users/runner/work/nim4py/nim4py/Nim/compiler/procfind.nim", 58);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*, searchForProc__WIQjdZgnZBgByteqPM0pPw)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TScope__1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* fn) {
		...
		while (1) {
			if (!!((result == NIM_NIL))) goto LA2;
			{
				...
				{
					{
						...
						T16_ = getProcHeader__bRG2xX9ar5tfMW3c7xo9ccKQ((*(*c).graph).config, result, ((tyEnum_TPreferedDesc__tnd4qt9c4xddV8oKV5zyusw) 0), NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						T15_[0] = T16_;
						T17_ = (NimStringDesc*)0;
						T17_ = dollar___aQsiZUvE4SFfnWyKx1JgKA((*(*c).graph).config, (*result).info);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						T15_[1] = T17_;
						message = nsuFormatOpenArray(((NimStringDesc*) &TM__UQi3TxvDqkoRVo8YKAWcxA_2), T15_, 2);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, (*fn).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), message, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__UQi3TxvDqkoRVo8YKAWcxA_3, NIM_FALSE);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					LA13_: ;
					goto BeforeRet_;
				...
				case ((tyEnum_TParamsEquality__fvN026oaoXOuZ9ajGPibaYQ) 2):
				{
					...
					T20_ = nsuFormatSingleElem(((NimStringDesc*) &TM__UQi3TxvDqkoRVo8YKAWcxA_5), (*(*fn).name).s);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					liMessage__Q6JNH4uRwLyZrj0dJakHew((*(*c).graph).config, T19_, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 10), T20_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__UQi3TxvDqkoRVo8YKAWcxA_6, NIM_FALSE);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					goto BeforeRet_;
				}
				break;
