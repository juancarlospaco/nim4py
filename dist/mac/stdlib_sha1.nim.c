...
static N_INLINE(void, swapEndian32__Y7K2twSvEFXjEQtANWmrhg_2endians)(void* outp, void* inp) {
	...
	copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(((void*) ((&tmpX60gensym1_))), inp, ((NI) 4));
	tmpX60gensym1_ = __builtin_bswap32(tmpX60gensym1_);
	copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(outp, ((void*) ((&tmpX60gensym1_))), ((NI) 4));
}
static N_INLINE(void, bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians)(void* outp, void* inp) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
...
{nimErr_ = nimErrorFlag();
	...
	e = (*ctx).state[(((NI) 4))- 0];
	{
		while (1) {
			...
			if (!(t < ((NI) 15))) goto LA2;
			T3_ = (void*)0;
			T3_ = ((void*) ((&w[((NI)(t + ((NI) 0)))- 0])));
			bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T3_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 0)) * ((NI) 4)))- 0]))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			T4_ = (void*)0;
			T4_ = ((void*) ((&w[((NI)(t + ((NI) 1)))- 0])));
			bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T4_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 1)) * ((NI) 4)))- 0]))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			T5_ = (void*)0;
			T5_ = ((void*) ((&w[((NI)(t + ((NI) 2)))- 0])));
			bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T5_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 2)) * ((NI) 4)))- 0]))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			T6_ = (void*)0;
			T6_ = ((void*) ((&w[((NI)(t + ((NI) 3)))- 0])));
			bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T6_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 3)) * ((NI) 4)))- 0]))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			T7_ = (void*)0;
			T7_ = ((void*) ((&w[((NI)(t + ((NI) 4)))- 0])));
			bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T7_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 4)) * ((NI) 4)))- 0]))));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	T8_ = (void*)0;
	T8_ = ((void*) ((&w[((NI)(t + ((NI) 0)))- 0])));
	bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T8_, ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 0)) * ((NI) 4)))- 0]))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	e += (NU32)((NU32)((NU32)((NU32)((NU32)((NU32)((NU32)((NU32)((NU32)(a) >> (NU64)(((NI) 27))) | (NU32)((NU64)(a) << (NU64)(((NI) 5))))) + (NU32)(w[((NI)(t + ((NI) 0)))- 0]))) + (NU32)((NU32)(d ^ (NU32)(b & (NU32)(c ^ d)))))) + (NU32)(((NU32) 1518500249)));
	b = (NU32)((NU32)((NU32)(b) >> (NU64)(((NI) 2))) | (NU32)((NU64)(b) << (NU64)(((NI) 30))));
...
{nimErr_ = nimErrorFlag();
	...
	len = dataLen_0;
	{
		...
		T5_ = (void*)0;
		T5_ = ((void*) ((&(*ctx).buf[(i)- 0])));
		copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(T5_, ((void*) ((&data[j]))), ((NI) ((NI)(((NI) 64) - i))));
		len -= (NI)(((NI) 64) - i);
		j += (NI)(((NI) 64) - i);
...
static N_INLINE(void, swapEndian64__Y7K2twSvEFXjEQtANWmrhg_4endians)(void* outp, void* inp) {
	...
	copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(((void*) ((&tmpX60gensym0_))), inp, ((NI) 8));
	tmpX60gensym0_ = __builtin_bswap64(tmpX60gensym0_);
	copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(outp, ((void*) ((&tmpX60gensym0_))), ((NI) 8));
}
static N_INLINE(void, bigEndian64__Y7K2twSvEFXjEQtANWmrhg_3endians)(void* outp, void* inp) {
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				bigEndian32__Y7K2twSvEFXjEQtANWmrhgendians(T6_, ((void*) ((&(*ctx).state[(i)- 0]))));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				i_2 += ((NI) 1);
			} LA5: ;
		}
