...
STRING_LITERAL(TM__M5T16KOkc0tDi9bZeKl6v1w_5, "/Users/runner/work/nim4py/nim4py/Nim/compiler/modules.nim", 57);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		T16_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
		{
			...
			LA20_: ;
			if (!T19_) goto LA21_;
			T16_ = llStreamOpen__ocAqkLNlxt5nOhrSLH4gwQ(__stdinp);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA17_;
		LA21_: ;
	...
	LA7_: ;
	{
		...
		T30_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
		{
			...
			LA34_: ;
			if (!T33_) goto LA35_;
			T30_ = llStreamOpen__ocAqkLNlxt5nOhrSLH4gwQ(__stdinp);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
		goto LA31_;
		LA35_: ;
